       ...
       <div className="stat-card">
        ...
        <table>
          <thead>
            ...
            <td>Illegal Du...</td>
            <td>Mile 4</td>
            <td style={{background:"brown",padding:"2px",borderRadius:"3px",color:"white"}}>pending</td>
            <td>04/02/2025</td>
            <td>
            ...
            <td>Dump Repor...</td>
            <td>Mile 90</td>
            <td style={{background:"#23AE60",padding:"2px",borderRadius:"3px",color:"white"}}>resolved</td>
            <td>05/02/2025</td>
            <td>
                  <div className="editDel">
                  <FaCheckCircle className="resolve-icon" style={{color:"#23AE60",fontSize:"20px",cursor:"pointer"}}/>
